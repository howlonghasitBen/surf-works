  ...
  <footer className="footer">
    <div className="footer-content">
      <div className="footer-section">
        <h3>🌊 SURF WORKS</h3>
        <p>
          Riding the waves of web3 innovation. Learn, create, and surf the
          decentralized future with cutting-edge blockchain technology and NFT
          artistry.
        </p>
      ...
      <div className="footer-section">
        <h3>🔗 Connect</h3>
        <p>
          Join the community and stay updated with the latest waves in web3!
        </p>
        <div className="social-links">
          ...
          <a
            href="https://discord.gg/WZnMhsFGXn"
            target="_blank"
            rel="noopener noreferrer"
            title="Discord"
          >
